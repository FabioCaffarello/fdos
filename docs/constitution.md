...
| 11 | Contracts Over Implementations | `layering`, `buf breaking` against main, wire/domain round-trip conformance, and cross-module source compatibility (`make proto-check`, `make test`, `make workspace-check`, `make pin-check`) | 3 | 3 ✅ |
