...
| M11 | **Transport** — first composition root in `apps/`: a submission service over `fdos.ingest.v1`; makes D2 a live decision | plan gate [PR #63](https://github.com/FabioCaffarello/fdos/pull/63); two preconditions named there — ADR-0029's "never a service" clause, and D2 |
